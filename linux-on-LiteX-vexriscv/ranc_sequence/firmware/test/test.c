...
void load_neuron_parameter(void){
	...
	while (fgets((char*)param_string, 94, fptr) != NULL){
		...
		// fgets(param_string,sizeof(param_string), fptr);
        // printf("Param %d %s\n",i, param_string );
...
int main (){
	...
	// 		// printf("%X\n", param[j]);
	// 		printf("Parameter %3d: %8X %8X %8X %8X %8X %8X %8X %8X %8X %8X %8X %8X \n", j, param[0],param[1],param[2],param[3],param[4],param[5], param[6],param[7],param[8],param[9],param[10],param[11]);
