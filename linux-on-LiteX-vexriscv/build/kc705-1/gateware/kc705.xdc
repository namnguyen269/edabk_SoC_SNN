...
# eth_clocks:0.tx
set_property LOC M28 [get_ports {eth_clocks_tx}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_clocks_tx}]

# eth_clocks:0.gtx
set_property LOC K30 [get_ports {eth_clocks_gtx}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_clocks_gtx}]

# eth_clocks:0.rx
set_property LOC U27 [get_ports {eth_clocks_rx}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_clocks_rx}]

# eth:0.rst_n
set_property LOC L20 [get_ports {eth_rst_n}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_rst_n}]

# eth:0.int_n
set_property LOC N30 [get_ports {eth_int_n}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_int_n}]

# eth:0.mdio
set_property LOC J21 [get_ports {eth_mdio}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_mdio}]

# eth:0.mdc
set_property LOC R23 [get_ports {eth_mdc}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_mdc}]

# eth:0.rx_dv
set_property LOC R28 [get_ports {eth_rx_dv}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_rx_dv}]

# eth:0.rx_er
set_property LOC V26 [get_ports {eth_rx_er}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_rx_er}]

# eth:0.rx_data
set_property LOC U30 [get_ports {eth_rx_data[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_rx_data[0]}]

# eth:0.rx_data
set_property LOC U25 [get_ports {eth_rx_data[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_rx_data[1]}]

# eth:0.rx_data
set_property LOC T25 [get_ports {eth_rx_data[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_rx_data[2]}]

# eth:0.rx_data
set_property LOC U28 [get_ports {eth_rx_data[3]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_rx_data[3]}]

# eth:0.rx_data
set_property LOC R19 [get_ports {eth_rx_data[4]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_rx_data[4]}]

# eth:0.rx_data
set_property LOC T27 [get_ports {eth_rx_data[5]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_rx_data[5]}]

# eth:0.rx_data
set_property LOC T26 [get_ports {eth_rx_data[6]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_rx_data[6]}]

# eth:0.rx_data
set_property LOC T28 [get_ports {eth_rx_data[7]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_rx_data[7]}]

# eth:0.tx_en
set_property LOC M27 [get_ports {eth_tx_en}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_tx_en}]

# eth:0.tx_er
set_property LOC N29 [get_ports {eth_tx_er}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_tx_er}]

# eth:0.tx_data
set_property LOC N27 [get_ports {eth_tx_data[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_tx_data[0]}]

# eth:0.tx_data
set_property LOC N25 [get_ports {eth_tx_data[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_tx_data[1]}]

# eth:0.tx_data
set_property LOC M29 [get_ports {eth_tx_data[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_tx_data[2]}]

# eth:0.tx_data
set_property LOC L28 [get_ports {eth_tx_data[3]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_tx_data[3]}]

# eth:0.tx_data
set_property LOC J26 [get_ports {eth_tx_data[4]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_tx_data[4]}]

# eth:0.tx_data
set_property LOC K26 [get_ports {eth_tx_data[5]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_tx_data[5]}]

# eth:0.tx_data
set_property LOC L30 [get_ports {eth_tx_data[6]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_tx_data[6]}]

# eth:0.tx_data
set_property LOC J28 [get_ports {eth_tx_data[7]}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_tx_data[7]}]

# eth:0.col
set_property LOC W19 [get_ports {eth_col}]
set_property IOSTANDARD LVCMOS25 [get_ports {eth_col}]

# eth:0.crs
set_property LOC R30 [get_ports {eth_crs}]
