...
| Register                                           | Address                                  |
+====================================================+==========================================+
| :ref:`SDCORE_CMD_ARGUMENT <SDCORE_CMD_ARGUMENT>`   | :ref:`0xf0004800 <SDCORE_CMD_ARGUMENT>`  |
+----------------------------------------------------+------------------------------------------+
| :ref:`SDCORE_CMD_COMMAND <SDCORE_CMD_COMMAND>`     | :ref:`0xf0004804 <SDCORE_CMD_COMMAND>`   |
+----------------------------------------------------+------------------------------------------+
| :ref:`SDCORE_CMD_SEND <SDCORE_CMD_SEND>`           | :ref:`0xf0004808 <SDCORE_CMD_SEND>`      |
+----------------------------------------------------+------------------------------------------+
| :ref:`SDCORE_CMD_RESPONSE3 <SDCORE_CMD_RESPONSE3>` | :ref:`0xf000480c <SDCORE_CMD_RESPONSE3>` |
+----------------------------------------------------+------------------------------------------+
| :ref:`SDCORE_CMD_RESPONSE2 <SDCORE_CMD_RESPONSE2>` | :ref:`0xf0004810 <SDCORE_CMD_RESPONSE2>` |
+----------------------------------------------------+------------------------------------------+
| :ref:`SDCORE_CMD_RESPONSE1 <SDCORE_CMD_RESPONSE1>` | :ref:`0xf0004814 <SDCORE_CMD_RESPONSE1>` |
+----------------------------------------------------+------------------------------------------+
| :ref:`SDCORE_CMD_RESPONSE0 <SDCORE_CMD_RESPONSE0>` | :ref:`0xf0004818 <SDCORE_CMD_RESPONSE0>` |
+----------------------------------------------------+------------------------------------------+
| :ref:`SDCORE_CMD_EVENT <SDCORE_CMD_EVENT>`         | :ref:`0xf000481c <SDCORE_CMD_EVENT>`     |
+----------------------------------------------------+------------------------------------------+
| :ref:`SDCORE_DATA_EVENT <SDCORE_DATA_EVENT>`       | :ref:`0xf0004820 <SDCORE_DATA_EVENT>`    |
+----------------------------------------------------+------------------------------------------+
| :ref:`SDCORE_BLOCK_LENGTH <SDCORE_BLOCK_LENGTH>`   | :ref:`0xf0004824 <SDCORE_BLOCK_LENGTH>`  |
+----------------------------------------------------+------------------------------------------+
| :ref:`SDCORE_BLOCK_COUNT <SDCORE_BLOCK_COUNT>`     | :ref:`0xf0004828 <SDCORE_BLOCK_COUNT>`   |
+----------------------------------------------------+------------------------------------------+
