...
| Register                                             | Address                                   |
+======================================================+===========================================+
| :ref:`SDPHY_CARD_DETECT <SDPHY_CARD_DETECT>`         | :ref:`0xf0006000 <SDPHY_CARD_DETECT>`     |
+------------------------------------------------------+-------------------------------------------+
| :ref:`SDPHY_CLOCKER_DIVIDER <SDPHY_CLOCKER_DIVIDER>` | :ref:`0xf0006004 <SDPHY_CLOCKER_DIVIDER>` |
+------------------------------------------------------+-------------------------------------------+
| :ref:`SDPHY_INIT_INITIALIZE <SDPHY_INIT_INITIALIZE>` | :ref:`0xf0006008 <SDPHY_INIT_INITIALIZE>` |
+------------------------------------------------------+-------------------------------------------+
| :ref:`SDPHY_DATAW_STATUS <SDPHY_DATAW_STATUS>`       | :ref:`0xf000600c <SDPHY_DATAW_STATUS>`    |
+------------------------------------------------------+-------------------------------------------+
