...
/* 0 if you do not want the Andes JTAG Programmer (deprecated). */
#define BUILD_AICE 0
...
#define BUILD_HLADAPTER_NULINK 0
...
#define PACKAGE_STRING "openocd 0.12.0-rc2+dev"
...
#define PACKAGE_VERSION "0.12.0-rc2+dev"
